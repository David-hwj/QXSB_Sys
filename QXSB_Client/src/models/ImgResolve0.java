...
//			lowVideoPanel.add(initPic);
	...
	public String resolve() {
		...
		try {
			...
			proc = Runtime.getRuntime().exec("python C:\\face\\models\\birdge2.py "+videoPath);// 执行py文件
			System.out.println("模型处理视频结束1");
			//用输入输出流来截取结果
		...
		JOptionPane.showMessageDialog(null,"图片处理完毕，识别结果已保存在目录：\nC:\\a2");
	/*	fun();
